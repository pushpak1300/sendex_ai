...
namespace ArdaGnsrn\ElevenLabs\Facades {
     ...
     */        class ElevenLabs {
         ...
         *
         * @static 
         */        public static function textToSpeech($voiceId, $text, $modelId = 'eleven_multilingual_v2', $voiceSettings = [])
        {
                        /** @var \ArdaGnsrn\ElevenLabs\ElevenLabs $instance */
                        return $instance->textToSpeech($voiceId, $text, $modelId, $voiceSettings);
        }
                    /**
         * Get all models
         *
...
namespace  {
            ...
            class ElevenLabs extends \ArdaGnsrn\ElevenLabs\Facades\ElevenLabs {}
